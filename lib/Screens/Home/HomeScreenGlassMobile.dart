...
class HomeScreenGlassMobile extends StatefulWidget {
  const HomeScreenGlassMobile({super.key});

  @override
  createState() => HomeScreenGlassMobileState();
}

class HomeScreenGlassMobileState extends State<HomeScreenGlassMobile> {
